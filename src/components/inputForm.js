  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        <div className={offer != 'garazova brana' ? 'form-hidden' : null}>


          <div className="field">
            <label>Rozmery brány</label>
          </div>
          <div className="field ">
            <label>Šírka(m)</label>
        ...
        <div className={offer != 'oplotenie' ? 'form-hidden' : null}>
          <div className="field">
            <label>Rozmery oplotenia</label>
          </div>
          <div className="field ">
            <label>Šírka(m)</label>
            <input type="text" name="sizeWidth" value={sizeWidth} onChange={this.handleChange} />
...
Viac informácií nájdete v sekcii
          <a href="/spracovanie-osobnych-udajov" target="_blank" rel="noopener noreferrer"><strong> spracovanie osobných údajov </strong></a>
        </p>
        )}
